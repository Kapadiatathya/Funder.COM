...
public class BlogControllerTest {
    ...
    void getAllBlogsTest() throws Exception {
        ...
        Blog blog1 = new Blog();
        blog1.setTitle("Next-Level Gaming On-The-Go: Unveiling the Ultimate Alternative to the Steam Deck");
        blog1.setContent("Embark on a gaming revolution with our latest handheld marvel.");
        blog1.setBlogType("Technology");
        blog1.setImageName("https://rb.gy/l5r8m8");
        blog1.setAddedDate(addDateBlog1);
        blog1.setShortDescription("Elevate your on-the-go gaming experience like never before.");
        Blog blog2 = new Blog();
    ...
    public void getBlogByIdTest() throws Exception{
        ...
        blog.setContent("Discover innovation at its.");
